...
public class LRUCacheUnitTest extends TestCase {
    ...
    public void testPutGetLRUCacheUNIT(){
        String key = "foo";
        String value = "bar";
        Exception ex = null;
        String value_back = "";
    ...
    @Test
    public void testEvictionLRUCacheUNIT(){
        String key1 = "foo1";
        String key2 = "foo2";
        String key3 = "foo3";
        String key4 = "foo4";
        ...
        try {
            ...
            key_there = cache.contains(key2);
            cache.putKV(key3, value);
            cache.getKV(key1);
            cache.getKV(key3);
            cache.putKV(key4, value);
            key_there_now = cache.contains(key2); //cache size is three, so key2 should be evicted as LRU
        }
        catch(Exception e){
            System.out.println(e);
            ex = e;
    ...
    @Test
    public void testDeleteKeyLRUCacheUNIT(){
        String key = "foo1";
        String value = "bar";
        Exception ex = null;
        boolean key_there = false;
